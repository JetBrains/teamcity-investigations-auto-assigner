...
public class BuildProblemTypesFetcher implements ProjectDataFetcher {

  @NotNull
  @Override
  public List<DataItem> retrieveData(@NotNull final Browser fsBrowser, @NotNull final String projectFilePath) {
    List<DataItem> dataItems = new ArrayList<>();
    for (Map.Entry<String, String> entry : BuildProblemsFilter.SUPPORTED_TYPES.entrySet()) {
